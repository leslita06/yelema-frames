...
const plotted = points.map((p) => ({ ...p, x: p.ready }));
const xThreshold = 60;
const yThreshold = 60;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full min-h-screen bg-background text-foreground p-4 space-y-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 md:flex-row md:items-end md:justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "text-2xl md:text-3xl font-semibold tracking-tight", children: "Comparables IA agents \u2014 ready-to-go vs Build & Operate" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground max-w-4xl", children: "Quadrant \xAB comment on gagne \xBB : axe X = agents \xE0 construire (plateformes DIY, dev sur-mesure) \u2192 agents pr\xEAts \xE0 l'emploi. Axe Y inchang\xE9 (Build & Operate). Scoring X heuristique 11/06 depuis Business Model + RUN 00.3." })
      ] }),
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-3", children: [
        /* @__PURE__ */ jsx("div", { className: "w-full", style: { height: "760px" }, children: /* @__PURE__ */ jsxs("svg", { viewBox: `0 0 ${width} ${height}`, className: "w-full h-full", role: "img", "aria-label": "Quadrant strat\xE9gique des comparables IA agents", children: [
          ...
          /* @__PURE__ */ jsx("text", { x: margin.left, y: margin.top - 24, fontSize: "15", fontWeight: "700", fill: "hsl(var(--foreground))", children: "Haut-gauche : custom op\xE9r\xE9 (agences/managed)" }),
          /* @__PURE__ */ jsx("text", { x: sx(73), y: margin.top - 24, fontSize: "15", fontWeight: "700", fill: "hsl(var(--foreground))", children: "Haut-droite : pr\xEAt \xE0 l'emploi + op\xE9r\xE9" }),
          /* @__PURE__ */ jsx("text", { x: margin.left, y: margin.top + plotH + 44, fontSize: "15", fontWeight: "700", fill: "hsl(var(--foreground))", children: "Bas-gauche : plateformes DIY & dev sur-mesure" }),
          /* @__PURE__ */ jsx("text", { x: sx(67), y: margin.top + plotH + 44, fontSize: "15", fontWeight: "700", fill: "hsl(var(--foreground))", children: "Bas-droite : produits self-serve / software-led" }),
          ...
          /* @__PURE__ */ jsx("text", { x: sx(81), y: sy(97) + 10, fontSize: "12", fill: "hsl(var(--muted-foreground))", children: "Agents pr\xEAts \xE0 l'emploi ET op\xE9r\xE9s \u2014 la promesse Yelema" }),
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "text-sm text-muted-foreground space-y-2", children: [
        /* @__PURE__ */ jsx("p", { children: "X : score de readiness 0-100 (15-35 = plateformes/dev \xE0 construire \xB7 40-60 = produits \xE0 forte int\xE9gration \xB7 65-90 = agents pr\xEAts \xE0 l'emploi). Seuil \xE0 60. Scoring heuristique 11/06 (Business Model + RUN 00.3) \u2014 confiance h\xE9rit\xE9e des fiches 00.3." }),
        ...
        /* @__PURE__ */ jsx("p", { children: "Le coin haut-droite au-del\xE0 de 80/80 mat\xE9rialise le white space Yelema : catalogue pr\xEAt \xE0 l'emploi (2-4 semaines), op\xE9r\xE9 bout en bout, localis\xE9 UEMOA. C'est la phrase \xAB ready-to-go agents, Build & Operate \xBB dessin\xE9e." })
      ] })
    ] })
  ] });
}
